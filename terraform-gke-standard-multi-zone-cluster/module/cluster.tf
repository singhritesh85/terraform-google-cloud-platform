...
resource "google_container_cluster" "gke_cluster" {
  ...
  location = "us-central1-a"  ### Zonal Cluster with multi-zone as node_locations had been used    ###var.gcp_region
  
  node_locations = ["us-central1-c"]  ###"us-central1-a" is by default selected in multi-zone as per the location ###data.google_compute_zones.available.names
